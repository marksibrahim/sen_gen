...
class First_Par():
    ...
    def sentence4(theme, action, character_num, character_gender, s1_noun, s1_verb, s3_auxverb, s3_verb):
        if character_num > 1:
            pronoun = "they"
            possessive = "their"
        ...
        if theme == "love":
            # array of metaphors organized by theme
            metaphor = ???

        s4 = pronoun + " " + s3_auxverb + " " + action + " " + pronoun + " " + noun + " that the " + s1_noun + " " + pronoun + s1_verb + " " + metaphor + "and" + pronoun + " " + s3_verb + "."
